    ...
    <div className="bg-white pb-64 container py-32 font-[200]">
      <div className="flex flex-col-reverse gap-7 md:flex-row items-center justify-center">
        <div className="flex-1">
          <div className="mb-8" data-aos="fade-right" data-aos-duration="3000">
          ...
          <a data-aos="zoom-in"
            href="#_"
            className="relative mt-12 inline-flex items-center px-8 py-3 overflow-hidden text-lg font-medium text-[#C68732] border-2 border-[#C68732] rounded-full hover:text-white group hover:bg-gray-50"
          >
        ...
        <div data-aos="fade-right" data-aos-duration="2000" className="flex-1 flex flex-col relative items-center justify-center mx-auto">
          <img
            src={img}
